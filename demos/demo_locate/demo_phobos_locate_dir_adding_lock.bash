...
#
# lock waiting bugfix on dir lock
ssh ${SERVER0} medium_locker lock dir ${DIR_SERVER0} ${SERVER0}:owner
#
...
#
# lock waiting bugfix on dir lock
ssh ${SERVER0} medium_locker lock dir ${DIR_SERVER1} ${SERVER1}:owner
#
...
sleep $READER
#
# unlock waiting bugfix on dir lock
ssh ${SERVER0} medium_locker unlock dir ${DIR_SERVER0} ${SERVER0}:owner
ssh ${SERVER0} medium_locker unlock dir ${DIR_SERVER1} ${SERVER1}:owner
#
echo
